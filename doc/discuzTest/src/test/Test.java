...
public class Test {
	...
	public static void main(String[] args) {
		...
		String s = uc.uc_authcode("8485m7QEfsvnOg9tKGvAsxlwXpAzZU6LhFA04pD6N0XIYG1cJVDh2Th83Qcci130UPHbXp+UNG0",
				"DECODE");
	...
	public static void testLogin() {
		...
		Client e = new Client();
		String result = e.uc_user_login("unique", "123456");
	...
	public static void testRegister() {
		...
		//setcookie('Example_auth', '', -86400);
		//		生成同步退出的代码
		String $returns = uc.uc_user_register("郭金明", "123456", "gjm@qq.com");
